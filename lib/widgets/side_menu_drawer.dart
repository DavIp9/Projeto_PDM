...
import '../screens/ecra_rankings.dart';
import '../screens/ecra_candidaturas.dart';
import '../screens/ecra_perfil.dart';
          ...
          children: [
                        ...
                        child: Row(
                          children: [
                            const CircleAvatar(
                              ...
                              child: Icon(Icons.person, color: Color(0xFF9C27B0), size: 32),
                            ),
            ...
            _buildMenuItem(
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const CandidaturasScreen()));
            }),
            _buildMenuItem(
