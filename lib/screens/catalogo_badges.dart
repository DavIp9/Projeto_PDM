...
class _CatalogoBadgesScreenState extends State<CatalogoBadgesScreen> {
  ...
  final List<String> levels = ['Lvl 1', 'Lvl 2', 'Lvl 3', 'Lvl 4', 'Lvl 5'];
  ...
  Future<void> _loadData() async {
    try {
      final areaList = await DatabaseHelper.instance.obterAreas();
      final badges = await DatabaseHelper.instance.obterBadgesCatalogo();
      setState(() {
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text(
                      badge['level'] != null ? badge['level'].toString().split(' ').last : 'Base',
